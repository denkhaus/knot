...
func TestLenientValidation(t *testing.T) {
	...
	_, err := validator.ValidateTransitionLenient(types.TaskStatePending, types.TaskStateCompleted, task)
	...
	warnings, err := validator.ValidateTransitionLenient(types.TaskStateInProgress, types.TaskStateCompleted, highComplexityTask)
