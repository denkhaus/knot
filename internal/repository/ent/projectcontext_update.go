...
func (_u *ProjectContextUpdate) SetSessionID(v uuid.UUID) *ProjectContextUpdate {
	_u.mutation.SetSessionID(v)
	return _u
}

// SetNillableSessionID sets the "session_id" field if the given value is not nil.
func (_u *ProjectContextUpdate) SetNillableSessionID(v *uuid.UUID) *ProjectContextUpdate {
	if v != nil {
		_u.SetSessionID(*v)
	}
	return _u
...
func (_u *ProjectContextUpdate) ClearSessionID() *ProjectContextUpdate {
	_u.mutation.ClearSessionID()
	return _u
}

// SetContextType sets the "context_type" field.
func (_u *ProjectContextUpdate) SetContextType(v projectcontext.ContextType) *ProjectContextUpdate {
	_u.mutation.SetContextType(v)
	return _u
}

// SetNillableContextType sets the "context_type" field if the given value is not nil.
func (_u *ProjectContextUpdate) SetNillableContextType(v *projectcontext.ContextType) *ProjectContextUpdate {
	if v != nil {
		_u.SetContextType(*v)
	}
	return _u
...
func (_u *ProjectContextUpdate) check() error {
	if v, ok := _u.mutation.ContextType(); ok {
		if err := projectcontext.ContextTypeValidator(v); err != nil {
			return &ValidationError{Name: "context_type", err: fmt.Errorf(`ent: validator failed for field "ProjectContext.context_type": %w`, err)}
		}
	}
...
func (_u *ProjectContextUpdate) sqlSave(ctx context.Context) (_node int, err error) {
	...
	if value, ok := _u.mutation.SessionID(); ok {
		_spec.SetField(projectcontext.FieldSessionID, field.TypeUUID, value)
	}
	if _u.mutation.SessionIDCleared() {
		_spec.ClearField(projectcontext.FieldSessionID, field.TypeUUID)
	}
	if value, ok := _u.mutation.ContextType(); ok {
		_spec.SetField(projectcontext.FieldContextType, field.TypeEnum, value)
	}
...
// SetSessionID sets the "session_id" field.
func (_u *ProjectContextUpdateOne) SetSessionID(v uuid.UUID) *ProjectContextUpdateOne {
	_u.mutation.SetSessionID(v)
	return _u
}

// SetNillableSessionID sets the "session_id" field if the given value is not nil.
func (_u *ProjectContextUpdateOne) SetNillableSessionID(v *uuid.UUID) *ProjectContextUpdateOne {
	if v != nil {
		_u.SetSessionID(*v)
	}
	return _u
...
// ClearSessionID clears the value of the "session_id" field.
func (_u *ProjectContextUpdateOne) ClearSessionID() *ProjectContextUpdateOne {
	_u.mutation.ClearSessionID()
	return _u
}

// SetContextType sets the "context_type" field.
func (_u *ProjectContextUpdateOne) SetContextType(v projectcontext.ContextType) *ProjectContextUpdateOne {
	_u.mutation.SetContextType(v)
	return _u
}

// SetNillableContextType sets the "context_type" field if the given value is not nil.
func (_u *ProjectContextUpdateOne) SetNillableContextType(v *projectcontext.ContextType) *ProjectContextUpdateOne {
	if v != nil {
		_u.SetContextType(*v)
	}
	return _u
