...
type ProjectContext struct {
	...
	// Session ID for MCP mode multi-session support (null for local mode)
	SessionID uuid.UUID `json:"session_id,omitempty"`
	// Type of context: local (CLI) or mcp (server)
	ContextType projectcontext.ContextType `json:"context_type,omitempty"`
	// When the selection was last updated
	UpdatedAt time.Time `json:"updated_at,omitempty"`
	// Who updated the selection (actor/user)
...
func (*ProjectContext) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case projectcontext.FieldContextType, projectcontext.FieldUpdatedBy:
			values[i] = new(sql.NullString)
		case projectcontext.FieldUpdatedAt:
			values[i] = new(sql.NullTime)
		case projectcontext.FieldSelectedProjectID, projectcontext.FieldSessionID:
	...
	for i := range columns {
		...
		case projectcontext.FieldContextType:
			if value, ok := values[i].(*sql.NullString); !ok {
				...
				_m.ContextType = projectcontext.ContextType(value.String)
			}
		case projectcontext.FieldUpdatedAt:
...
func (_m *ProjectContext) String() string {
	...
	builder.WriteString(fmt.Sprintf("%v", _m.ContextType))
	builder.WriteString(", ")
