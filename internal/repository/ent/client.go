...
import (
	...
	"github.com/denkhaus/knot/v2/internal/repository/ent/migrate"
...
type (
	hooks struct {
		Project, ProjectContext, Session, Task, TaskDependency []ent.Hook
	}
	inters struct {
		Project, ProjectContext, Session, Task, TaskDependency []ent.Interceptor
	}
)
