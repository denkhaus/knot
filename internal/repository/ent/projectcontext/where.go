...
func SessionID(v uuid.UUID) predicate.ProjectContext {
	return predicate.ProjectContext(sql.FieldEQ(FieldSessionID, v))
}
...
func SessionIDEQ(v uuid.UUID) predicate.ProjectContext {
	return predicate.ProjectContext(sql.FieldEQ(FieldSessionID, v))
}

// SessionIDNEQ applies the NEQ predicate on the "session_id" field.
func SessionIDNEQ(v uuid.UUID) predicate.ProjectContext {
	return predicate.ProjectContext(sql.FieldNEQ(FieldSessionID, v))
}

// SessionIDIn applies the In predicate on the "session_id" field.
func SessionIDIn(vs ...uuid.UUID) predicate.ProjectContext {
	return predicate.ProjectContext(sql.FieldIn(FieldSessionID, vs...))
}

// SessionIDNotIn applies the NotIn predicate on the "session_id" field.
func SessionIDNotIn(vs ...uuid.UUID) predicate.ProjectContext {
	return predicate.ProjectContext(sql.FieldNotIn(FieldSessionID, vs...))
}

// SessionIDGT applies the GT predicate on the "session_id" field.
func SessionIDGT(v uuid.UUID) predicate.ProjectContext {
	return predicate.ProjectContext(sql.FieldGT(FieldSessionID, v))
}

// SessionIDGTE applies the GTE predicate on the "session_id" field.
func SessionIDGTE(v uuid.UUID) predicate.ProjectContext {
	return predicate.ProjectContext(sql.FieldGTE(FieldSessionID, v))
}

// SessionIDLT applies the LT predicate on the "session_id" field.
func SessionIDLT(v uuid.UUID) predicate.ProjectContext {
	return predicate.ProjectContext(sql.FieldLT(FieldSessionID, v))
}

// SessionIDLTE applies the LTE predicate on the "session_id" field.
func SessionIDLTE(v uuid.UUID) predicate.ProjectContext {
	return predicate.ProjectContext(sql.FieldLTE(FieldSessionID, v))
}

// SessionIDIsNil applies the IsNil predicate on the "session_id" field.
func SessionIDIsNil() predicate.ProjectContext {
	return predicate.ProjectContext(sql.FieldIsNull(FieldSessionID))
}

// SessionIDNotNil applies the NotNil predicate on the "session_id" field.
func SessionIDNotNil() predicate.ProjectContext {
	return predicate.ProjectContext(sql.FieldNotNull(FieldSessionID))
}

// ContextTypeEQ applies the EQ predicate on the "context_type" field.
func ContextTypeEQ(v ContextType) predicate.ProjectContext {
	return predicate.ProjectContext(sql.FieldEQ(FieldContextType, v))
}

// ContextTypeNEQ applies the NEQ predicate on the "context_type" field.
func ContextTypeNEQ(v ContextType) predicate.ProjectContext {
	return predicate.ProjectContext(sql.FieldNEQ(FieldContextType, v))
}

// ContextTypeIn applies the In predicate on the "context_type" field.
func ContextTypeIn(vs ...ContextType) predicate.ProjectContext {
	return predicate.ProjectContext(sql.FieldIn(FieldContextType, vs...))
}

// ContextTypeNotIn applies the NotIn predicate on the "context_type" field.
func ContextTypeNotIn(vs ...ContextType) predicate.ProjectContext {
	return predicate.ProjectContext(sql.FieldNotIn(FieldContextType, vs...))
}
