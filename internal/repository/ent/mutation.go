...
type ProjectContextMutation struct {
	...
	context_type            *projectcontext.ContextType
	updated_at              *time.Time
	updated_by              *string
	clearedFields           map[string]struct{}
...
func (m *ProjectContextMutation) SetSessionID(u uuid.UUID) {
	m.session_id = &u
}

// SessionID returns the value of the "session_id" field in the mutation.
func (m *ProjectContextMutation) SessionID() (r uuid.UUID, exists bool) {
	v := m.session_id
	if v == nil {
		return
	}
...
// OldSessionID returns the old "session_id" field's value of the ProjectContext entity.
// If the ProjectContext object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *ProjectContextMutation) OldSessionID(ctx context.Context) (v uuid.UUID, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *ProjectContextMutation) ClearSessionID() {
	m.session_id = nil
	m.clearedFields[projectcontext.FieldSessionID] = struct{}{}
}

// SessionIDCleared returns if the "session_id" field was cleared in this mutation.
func (m *ProjectContextMutation) SessionIDCleared() bool {
	_, ok := m.clearedFields[projectcontext.FieldSessionID]
	return ok
}

// ResetSessionID resets all changes to the "session_id" field.
func (m *ProjectContextMutation) ResetSessionID() {
	m.session_id = nil
	delete(m.clearedFields, projectcontext.FieldSessionID)
}

// SetContextType sets the "context_type" field.
func (m *ProjectContextMutation) SetContextType(pt projectcontext.ContextType) {
	m.context_type = &pt
}

// ContextType returns the value of the "context_type" field in the mutation.
func (m *ProjectContextMutation) ContextType() (r projectcontext.ContextType, exists bool) {
	v := m.context_type
	if v == nil {
		return
	}
...
// OldContextType returns the old "context_type" field's value of the ProjectContext entity.
// If the ProjectContext object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *ProjectContextMutation) OldContextType(ctx context.Context) (v projectcontext.ContextType, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *ProjectContextMutation) ResetContextType() {
	m.context_type = nil
}
...
func (m *ProjectContextMutation) Fields() []string {
	...
	if m.session_id != nil {
		fields = append(fields, projectcontext.FieldSessionID)
	}
	if m.context_type != nil {
		fields = append(fields, projectcontext.FieldContextType)
	}
	if m.updated_at != nil {
...
func (m *ProjectContextMutation) Field(name string) (ent.Value, bool) {
	...
	case projectcontext.FieldSessionID:
		return m.SessionID()
	case projectcontext.FieldContextType:
...
func (m *ProjectContextMutation) SetField(name string, value ent.Value) error {
	...
	case projectcontext.FieldSessionID:
		...
		return nil
	case projectcontext.FieldContextType:
		v, ok := value.(projectcontext.ContextType)
		if !ok {
			return fmt.Errorf("unexpected type %T for field %s", value, name)
		}
		m.SetContextType(v)
...
func (m *ProjectContextMutation) ClearedFields() []string {
	...
	if m.FieldCleared(projectcontext.FieldSessionID) {
		fields = append(fields, projectcontext.FieldSessionID)
	}
	return fields
}
...
func (m *SessionMutation) SetActor(s string) {
	m.actor = &s
}

// Actor returns the value of the "actor" field in the mutation.
func (m *SessionMutation) Actor() (r string, exists bool) {
	v := m.actor
	if v == nil {
		return
	}
...
// OldActor returns the old "actor" field's value of the Session entity.
// If the Session object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *SessionMutation) OldActor(ctx context.Context) (v string, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *SessionMutation) ClearActor() {
	m.actor = nil
	m.clearedFields[session.FieldActor] = struct{}{}
}

// ActorCleared returns if the "actor" field was cleared in this mutation.
func (m *SessionMutation) ActorCleared() bool {
	_, ok := m.clearedFields[session.FieldActor]
	return ok
}

// ResetActor resets all changes to the "actor" field.
func (m *SessionMutation) ResetActor() {
	m.actor = nil
	delete(m.clearedFields, session.FieldActor)
}
...
func (m *SessionMutation) SetProjectID(id uuid.UUID) {
	m.project = &id
}
...
func (m *SessionMutation) ProjectID() (id uuid.UUID, exists bool) {
	if m.project != nil {
...
func (m *SessionMutation) Fields() []string {
	...
	if m.actor != nil {
		fields = append(fields, session.FieldActor)
	}
	if m.status != nil {
...
func (m *SessionMutation) ClearedFields() []string {
	...
	if m.FieldCleared(session.FieldActor) {
		fields = append(fields, session.FieldActor)
	}
	return fields
}
