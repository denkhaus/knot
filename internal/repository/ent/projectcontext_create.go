...
func (_c *ProjectContextCreate) SetSessionID(v uuid.UUID) *ProjectContextCreate {
	_c.mutation.SetSessionID(v)
	return _c
}

// SetNillableSessionID sets the "session_id" field if the given value is not nil.
func (_c *ProjectContextCreate) SetNillableSessionID(v *uuid.UUID) *ProjectContextCreate {
	if v != nil {
		_c.SetSessionID(*v)
	}
	return _c
...
func (_c *ProjectContextCreate) SetContextType(v projectcontext.ContextType) *ProjectContextCreate {
	_c.mutation.SetContextType(v)
	return _c
}

// SetNillableContextType sets the "context_type" field if the given value is not nil.
func (_c *ProjectContextCreate) SetNillableContextType(v *projectcontext.ContextType) *ProjectContextCreate {
	if v != nil {
		_c.SetContextType(*v)
	}
	return _c
...
func (_c *ProjectContextCreate) defaults() {
	if _, ok := _c.mutation.ContextType(); !ok {
		v := projectcontext.DefaultContextType
		_c.mutation.SetContextType(v)
	}
...
func (_c *ProjectContextCreate) check() error {
	if _, ok := _c.mutation.ContextType(); !ok {
		return &ValidationError{Name: "context_type", err: errors.New(`ent: missing required field "ProjectContext.context_type"`)}
	}
