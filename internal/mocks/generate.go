...
//go:generate mockgen -source=../mcp/hints/interface.go -destination=mock_hint_integration.go -package=mocks Integration
//go:generate mockgen -source=../handlers/interfaces.go -destination=mock_sync_handlers.go -package=mocks SyncService
...
//go:generate mockgen -source=../sync/client/client.go -destination=mock_sync_rest_client.go -package=mocks RESTSyncClient
