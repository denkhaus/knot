...
// Source: internal/mcp/transports/interface.go
//
// Generated by this command:
//
//	mockgen -source=internal/mcp/transports/interface.go -destination=internal/mocks/mock_transport.go -package=mocks Transport
//
