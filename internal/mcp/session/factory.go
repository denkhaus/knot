...
// NewSessionManager is a convenience function that creates the appropriate session manager
// based on the current configuration (used in DI container)
func NewSessionManager(injector do.Injector) (Manager, error) {
	...
	factory := NewSessionStorageFactory(configService, loggerService)
